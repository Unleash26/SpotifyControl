...
enum OverlayLayout {
    ...
    // Keep the transparent panel exactly aligned with the visible card. An outer
    // gutter would intercept clicks and becomes a visible halo on light content.
    static let windowWidth: CGFloat = width
    static let windowHeight: CGFloat = height

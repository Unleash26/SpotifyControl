...
- Visual source: `/var/folders/qk/q7mf_rz576n07ny_8tzd_fq80000gn/T/codex-clipboard-c297f173-d118-48ad-aae9-3360d98213b7.png`
...
- Reference state: Spotify is running and playing a track with title, artist, album, artwork, position, and duration available
...
- Draw elapsed progress as a small animated wave while playing. The remaining track is a quiet straight rail.
- Freeze the decorative wave when paused and replace its motion with a stable line when Reduce Motion is enabled.
...
| Wave seek control | Position divided by duration | Drag previews locally; release commits Spotify's player position. |
...
- Playing: wave moves and the displayed position advances smoothly between Spotify snapshots.
- Paused or stopped: wave is stable and the displayed position does not advance.
